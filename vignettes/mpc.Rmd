...
z1a <- plot(tdmorefit, population=F) + ggplot2::scale_y_log10() + ggplot2::ggtitle("EBE")
z1b <- parameterPlot.tdmorefit(tdmorefit, newdata=seq(5, 30))

tdmorefit <- estimate(m2, regimen=regimen, observed=data.frame(TIME=c(7, 15, 23), CONC=c(10, 20, 30)))
z2a <- plot(tdmorefit, population=F) + ggplot2::scale_y_log10() + ggplot2::ggtitle("MPC")
z2b <- parameterPlot.tdmorefit(tdmorefit, newdata=seq(5, 30))

gridExtra::grid.arrange(z1a, z2a, z1b, z2b, nrow=2)
```
