...
optimize <- function(fit, regimen, truth) {
  ...
  regimen$AMT[i] <- round_any( regimen$AMT[i] * Fct, 20) #round to tablet size
  return( list(regimen=regimen) )
}
...
optimize <- function(fit, regimen, truth) {
  ...
  recommendation$regimen$AMT <- round_any(recommendation$regimen$AMT, 20) #round to tablet size
