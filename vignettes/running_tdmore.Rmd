...
Both eta's from the res array maximises the likelihood for this specific subject. Predictions for the population (pred) and this specific subject can be compared by doing: 
...
Default TDMore plotting function can also be used, as follows:
