...
RUN R -e 'devtools::install_version("MCMCpack")'
RUN R -e 'devtools::install_version("mcmc")'
RUN R -e 'devtools::install_version("coda")'
RUN R -e 'devtools::install_version("quantreg")'
RUN R -e 'devtools::install_version("SparseM")'
RUN R -e 'devtools::install_version("MatrixModels")'
...
RUN R -e 'devtools::install_version("RxODE")'
RUN R -e 'devtools::install_version("nlmixr")'
